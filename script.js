...
/* ========== Matrix BG (Optimized Load + Smooth Start) ========== */
const c = document.getElementById("matrix");
const ctx = c.getContext("2d");
let W = (c.width = innerWidth),
    H = (c.height = innerHeight);
const size = 18; // ukuran font matrix
...
// Tambahkan efek fade-in biar gak white flash
c.style.opacity = "0";
...
function loop() {
  ...
  // efek kabur ringan supaya smooth
...
// Jalankan animasi setelah halaman & CSS siap
window.addEventListener("load", () => {
  setTimeout(() => {
    c.style.opacity = "1"; // muncul perlahan
    loop();
  }, 300); // delay kecil biar DOM & font siap dulu
});
